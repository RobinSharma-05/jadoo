...
const Header = () => {
    return (
        <div className='pt-5 mt-5'>
            <Row>
                <Col lg={6} data-aos="fade-right" data-aos-delay="100" data-aos-duration="700">
                ...
                <Col lg={6} className="position-relative" data-aos="fade-left" data-aos-delay="100" data-aos-duration="700">
